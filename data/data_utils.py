...
import sys
sys.path.append("../research-lag-transformer/data")
from read_new_dataset import get_ett_dataset, create_train_dataset_without_last_k_timesteps, TrainDatasets, MetaData

DATASET_VAL_START_DATES = {
    "traffic_nips": pd.Timestamp(year=2008, month=6, day=1),
    "uber_tlc_hourly": pd.Timestamp(year=2015, month=8, day=1),
}
...
def create_train_and_val_datasets_with_dates(
    ...
    if name in ("m5"):
        raw_dataset = get_dataset("m5", Path("datasets/"))
    elif name in ("ett_h1", "ett_h2", "ett_m1", "ett_m2"):
        path = "/Users/henaghonia/Downloads/research-lag-transformer/datasets/ett_datasets"
        ...
        path = "/Users/henaghonia/Downloads/research-lag-transformer/datasets/huawei/" + name + ".json"
        ...
        path = "/Users/henaghonia/Downloads/research-lag-transformer/datasets/air_quality/" + name + ".json"
    ...
    # Get validation data
    # NOTE: If problems happen, revert to choosing/iterating through all windows manually - like in https://github.com/ashok-arjun/tactis/blob/tactis-2/tactis/gluon/dataset.py#L444
    total_val_points = 0
    total_val_windows = 0
    val_data = []
    for i, series in enumerate(raw_train_dataset):
...
def create_test_dataset(
    name, dataset_path, history_length, debug=False, freq=None, data_id=None
):
    """
    ...
    if name in ("m5"):
        dataset = get_dataset("m5", Path("/home/toolkit/datasets"))
    elif name in ("ett_h1", "ett_h2", "ett_m1", "ett_m2"):
        path = "/Users/henaghonia/Downloads/research-lag-transformer/datasets/ett_datasets"
...
if __name__ == "__main__":
    ...
    TRAIN_START_DATE = None
    HISTORY_LENGTH = 256  # Arbitrary
    PRED_LEN = 1 # None for Lag-Transformer testing
    ...
    test_dataset, _, _ = create_test_dataset(NAME, DATASET_PATH, HISTORY_LENGTH)
    ...
    # DATA_ID = 1
    # (
    #     uber_tlc_hourly_train_dataset,
    #     uber_tlc_hourly_val_dataset,
    #     total_train_points,
    #     total_val_points,
    #     total_val_windows,
    #     max_train_end_date,
